export default function Resources() {
  return (
    <section class="relative py-20 2xl:py-40 bg-dxt-bg-primary overflow-hidden">
      <div class="container px-4 mx-auto">
        <div class="mb-14 text-center">
          {/* <span class="text-lg text-blue-400 font-bold">
            What&apos;s new at Shuffle
          </span> */}
          <h2 class="mt-8 text-5xl font-bold font-heading text-white font-nunito">
            Resource centre
          </h2>
        </div>
        <div class="flex flex-wrap -m-6">
          <div class="relative w-full lg:w-1/3 p-6">
            <img
              class="hidden lg:block absolute top-0 left-0 -ml-40 mt-24"
              src="zospace-assets/lines/left-line.svg"
              alt=""
            />
            <div class="relative z-10 bg-dxt-accents-1 rounded-lg">
              ...
              <div class="px-14 pb-10">
                <a
                  class="inline-block pt-4 text-lg text-white hover:text-gray-100 font-bold border-t border-gray-400"
                  href="#"
                >
          ...
          <div class="relative w-full lg:w-1/3 p-6">
            <img
              class="hidden lg:block absolute top-0 left-0 -ml-14 mt-24"
              src="zospace-assets/lines/right-line.svg"
              alt=""
            />
            <div class="relative z-10 lg:mt-24 bg-dxt-accents-1 rounded-lg">
              <div class="relative mb-8 h-52">
                <img
          ...
          <div class="relative w-full lg:w-1/3 p-6">
            <img
              class="hidden lg:block absolute top-0 right-0 mr-64 mt-24"
              src="zospace-assets/lines/left-line.svg"
              alt=""
            />
            <div class="relative z-10 bg-dxt-accents-1 rounded-lg">
              <div class="relative mb-8 h-52">
                <img
                  class="mb-8 w-full h-52 rounded-lg object-cover"
            ...
            <img
              class="hidden lg:block absolute top-0 right-0 -mr-32 mt-24"
              src="zospace-assets/lines/right-line.svg"
              alt=""
            />
          </div>
        ...
        <div class="mt-14 lg:mt-24 text-center">
          <a
            class="inline-block py-5 px-12 mr-4 bg-blue-500 hover:bg-blue-600 rounded-full text-white font-bold transition duration-200"
            href="#"
          >
            See all
          </a>
